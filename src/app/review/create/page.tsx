...
export default async function PageReviewCreate({
  ...
  return (
    <div className="min-h-screen">
      {/* Header Section */}
      <div className="overflow-hidden pt-16 pb-12">
        <div className="mx-auto max-w-4xl animate-appear px-4">
          <h1 className="flex flex-col items-center text-center">
            <div className="mb-6 flex size-20 items-center justify-center rounded-full bg-linear-to-br from-secondary to-[#6c3e6e]/40 shadow-lg">
