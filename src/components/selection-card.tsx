  ...
  return (
    <div
      ...
      className={cn(
        ...
        heightStyles,
        isSelected
          ? "border-primary bg-primary text-primary-fg shadow-lg ring-2 ring-primary/20"
          : "border-light-gray bg-white text-fg hover:border-primary/30 hover:bg-primary/5",
      )}
    >
      {/* Selection indicator */}
      {isSelected && (
        <div className="absolute top-3 right-3">
          <div className="flex size-6 items-center justify-center rounded-full bg-white/60 backdrop-blur-xs">
